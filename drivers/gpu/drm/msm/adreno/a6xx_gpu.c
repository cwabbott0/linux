...
static void a7xx_submit(struct msm_gpu *gpu, struct msm_gem_submit *submit)
{
	...
	/* /\* only enable preemption for userspace that supports it *\/ */
	/* OUT_PKT7(ring, CP_PREEMPT_DISABLE, 1); */
	/* OUT_RING(ring, !(submit->queue->flags & MSM_SUBMITQUEUE_ALLOW_PREEMPT)); */
	...
	/* /\* re-enable preemption after IBs have been execeuted *\/ */
	/* OUT_PKT7(ring, CP_PREEMPT_DISABLE, 1); */
	/* OUT_RING(ring, 0); */
