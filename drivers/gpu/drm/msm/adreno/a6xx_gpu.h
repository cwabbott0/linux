...
// note: 0x230000 is GMEM_SIZE + 0x110000
#define PREEMPT_OFFSET_SMMU_INFO 0
#define PREEMPT_OFFSET_PRIV_NON_SECURE (PREEMPT_OFFSET_SMMU_INFO + 4096)
#define PREEMPT_OFFSET_PRIV_SECURE (PREEMPT_OFFSET_PRIV_NON_SECURE + 3572 * SZ_1K)
#define PREEMPT_SIZE (PREEMPT_OFFSET_PRIV_SECURE + 3572 * SZ_1K)
